...
export const projects: Project[] = [
  {
    ...
    year: "2025",
    thumbnail: "/icons/proj-neon-drift.svg",
    ...
    media: [
      { type: "image", src: "/icons/placeholder-wide.svg", alt: "Neon Drift screenshot" },
      { type: "image", src: "/icons/placeholder-wide.svg", alt: "Neon Drift screenshot 2" },
    ],
  },
  {
    id: "chrome-sentinel",
    ...
    year: "2024",
    thumbnail: "/icons/proj-chrome-sentinel.svg",
    ...
    media: [
      ...
      { type: "image", src: "/icons/placeholder-wide.svg", alt: "Turntable render" },
    ],
  },
  {
    id: "signal-loop",
    ...
    year: "2024",
    thumbnail: "/icons/proj-signal-loop.svg",
    ...
    media: [{ type: "image", src: "/icons/placeholder-wide.svg", alt: "Signal Loop editor UI" }],
  },
];
